...
{
    /// <summary>
    /// This extension method adds the database configuration to the application builder.
    /// </summary>
    public static WebApplicationBuilder AddDatabase(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddDbContext<FridgeAppDatabaseContext>(options =>
            options.UseNpgsql(builder.Configuration.GetConnectionString("FridgeAppDatabase"), // This gets the connection string from ConnectionStrings.WebAppDatabase in appsettings.json.
